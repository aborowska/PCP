function fname = print_table_DM_old(DM, model, T, S)
    ...
    caption = ['\\caption{Diebold-Mariano test statistics for ',...
        ' pairwise method comparison of forecasting performance based on ',...
        'loss differential vectors of length $S = ',num2str(S),...
