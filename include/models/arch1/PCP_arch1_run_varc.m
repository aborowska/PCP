function results = PCP_arch1_run_varc(sdd, c, sigma1, sigma2, kappa, omega, alpha, ...
...
%     cont.mit.CV_tol = 0.3; 
    ...
    h_post_Cah = volatility_arch1(draw_Cah ,y,y_S,H);
    ...
    [draw_PCah, a_PCah, lnw_PCah] = sim_cond_mit_MH_outloop(mit_Cah, draw_short, partition, II, BurnIn, kernel, GamMat, cont.disp, thinning);
...
M_fin = M;
    ...
    h_post_PCah = volatility_arch1(draw_PCah,y,y_S,H);
