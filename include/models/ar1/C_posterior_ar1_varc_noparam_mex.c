...
void C_posterior_ar1_varc_noparam_mex(double *y, mwSignedIndex N, mwSignedIndex T,
        double *threshold, double *theta, double *d)
{
    mwSignedIndex *r1;
    double *r2, *a1, *P1, mu, sigma, y_mean; 
    double THR, cdf;
    mwSignedIndex i, j;
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    /* call the function */
    C_posterior_ar1_varc_noparam_mex(y, N, T, threshold, theta, d); 
    T_out[0] = T;
}
