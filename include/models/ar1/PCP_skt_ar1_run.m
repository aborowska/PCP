function results = PCP_skt_ar1_run(lambda, nu, rho,  ...
...
%     q5 = norminv(p_bar,c+rho*y(T:(T+H-1),1),sigma2)'; 
    ...
    q05 = skewtinv(p_bar0,nu,lambda) + rho*y(T:(T+H-1),1);  
    q1 = skewtinv(p_bar1,nu,lambda) + rho*y(T:(T+H-1),1); 
    q5 = skewtinv(p_bar,nu,lambda) + rho*y(T:(T+H-1),1);

    % true ESs
%     cdf05 = rho*y(T:(T+H-1),1) - skewtpdf(skewtinv(1-p_bar0,nu,lambda),nu,lambda)/(p_bar0);
%     cdf1 = rho*y(T:(T+H-1),1) - skewtpdf(skewtinv(1-p_bar1,nu,lambda),nu,lambda)/(p_bar1);
%     cdf5 = rho*y(T:(T+H-1),1) - skewtpdf(skewtinv(1-p_bar,nu,lambda),nu,lambda)/(p_bar);    
...
%     [draw_PC0, a_PC0] = sim_cond_mit_MH(mit_C0, draw_short, partition, M_short, BurnIn, kernel, GamMat);
    ...
    'VaR_1_post',VaR_1_post,'VaR_1_post_C',VaR_1_post_C,'VaR_1_post_PC',VaR_1_post_PC,'VaR_1_post_C0',VaR_1_post_C0,'VaR_1_post_PC0',VaR_1_post_PC0,...
    'VaR_5_post',VaR_5_post,'VaR_5_post_C',VaR_5_post_C,'VaR_5_post_PC',VaR_5_post_PC,'VaR_5_post_C0',VaR_5_post_C0,'VaR_5_post_PC0',VaR_5_post_PC0,...
    'VaR_05_post',VaR_05_post,'VaR_05_post_C',VaR_05_post_C,'VaR_05_post_PC',VaR_05_post_PC,'VaR_05_post_C0',VaR_05_post_C0,'VaR_05_post_PC0',VaR_05_post_PC0,...
    'ES_1_post',ES_1_post,'ES_1_post_C',ES_1_post_C,'ES_1_post_PC',ES_1_post_PC,'ES_1_post_C0',ES_1_post_C0,'ES_1_post_PC0',ES_1_post_PC0,...
    'ES_5_post',ES_5_post,'ES_5_post_C',ES_5_post_C,'ES_5_post_PC',ES_5_post_PC,'ES_5_post_C0',ES_5_post_C0,'ES_5_post_PC0',ES_5_post_PC0,...
    'ES_05_post',ES_05_post,'ES_05_post_C',ES_05_post_C,'ES_05_post_PC',ES_05_post_PC,'ES_05_post_C0',ES_05_post_C0,'ES_05_post_PC0',ES_05_post_PC0); 
end