function PCP_skt_ar1_MC_fun(T, lambda, nu, S)% varc, II)
%  PCP_ar1_MC_fun(10000, 2, 50, 1, 10)
 % T = 1000; S = 1; II = 10  ; % <------------------ !!! 
 % T = 10000; S = 1; II = 10;  varc = 0; ; % <------------------ !!! 
 % T = 100; S = 1; II = 10;   varc = 0; ; % <------------------ !!! 
% T = 1000; S=1; s = 1;   varc = 0;
%     clear all
    close all
...
%                     df, cont, options, partition, II, GamMat);
                ...
                results = PCP_skt_ar1_run(lambda, nu, rho, ...
                    p_bar0, p_bar1, p_bar, T, H, M, BurnIn, mu_init, ...
                    df, cont, options, partition, II, GamMat);
            end
            s = s+1;
...
%             'ES_05','ES_05_post','ES_05_post_Cah','ES_05_post_PCah','ES_05_post_Cm','ES_05_post_PCm');         
         ...
         save(name,...
            ...
            'VaR_1_post','VaR_1_post_C','VaR_1_post_PC','VaR_1_post_C0','VaR_1_post_PC0',...
            'VaR_5_post','VaR_5_post_C','VaR_5_post_PC','VaR_5_post_C0','VaR_5_post_PC0',...
            'VaR_05_post','VaR_05_post_C','VaR_05_post_PC','VaR_05_post_C0','VaR_05_post_PC0',...
            'MSE_1_post','MSE_1_post_C','MSE_1_post_PC','MSE_1_post_C0','MSE_1_post_PC0',...
            'MSE_5_post','MSE_5_post_C','MSE_5_post_PC','MSE_5_post_C0','MSE_5_post_PC0',...
            'MSE_05_post','MSE_05_post_C','MSE_05_post_PC','MSE_05_post_C0','MSE_05_post_PC0',...
            'ES_1_post','ES_1_post_C','ES_1_post_PC','ES_1_post_C0','ES_1_post_PC0',...
            'ES_5_post','ES_5_post_C','ES_5_post_PC','ES_5_post_C0','ES_5_post_PC0',...
            'ES_05_post','ES_05_post_C','ES_05_post_PC','ES_05_post_C0','ES_05_post_PC0');        
        end
    end
