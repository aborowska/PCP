...
void C_posterior_t_gas_mex(double *theta, double *y, double *threshold, 
 ...
 */       
    ...
    double h, *rho, rhoh, tmp, *A, *nu_con;
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    double *theta, *y, *threshold, *hyper;   /* input*/
    double *GamMat;       
//     double *d, *h;                                 /* output */
    double *d;                                 /* output */
...
//     h = mxGetPr(plhs[2]);
    ...
    /* call the function */
    C_posterior_t_gas_mex(theta, y, threshold, N, T, hyper, GamMat, G,  d); 
    T_out[0] = T;
}
