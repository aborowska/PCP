...
void C_addparam3_posterior_garch11_mex(double *theta_add, double *theta, double *y, double *threshold, double *y_S,
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    /* call the function */
    C_addparam3_posterior_garch11_mex(theta_add, theta, y, threshold, y_S, N, T, d, h); 
    T_out[0] = T;
}