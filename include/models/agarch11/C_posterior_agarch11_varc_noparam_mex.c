...
void C_posterior_agarch11_varc_noparam_mex(double *theta, double *y, double *threshold, double *y_S,
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    /* call the function */
    C_posterior_agarch11_varc_noparam_mex(theta, y, threshold, y_S, N, T, d, h); 
    T_out[0] = T;
}