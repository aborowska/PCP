...
void C_posterior_agarch11_varc_mle_mex(double *theta, double *y, double *mu_mle, double *threshold, double *y_S,
        mwSignedIndex N, mwSignedIndex T, double *d, double *h, double *THR)
{
    ...
    { 
        ...
        {
            mu = y[j-1] - mu_mle[2];
            h_mle = mu_mle[1]*(1.0-mu_mle[3]-mu_mle[4]) + mu_mle[3]*(mu*mu) + mu_mle[4]*h_mle;                  
        }       
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    /* call the function */
    C_posterior_agarch11_varc_mle_mex(theta, y, mu_mle, threshold, y_S, N, T, d, h, THR); 
    T_out[0] = T;
}