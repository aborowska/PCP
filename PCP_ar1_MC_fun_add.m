function PCP_ar1_MC_fun_add(T, sigma2, S, II)
...
%     std_mu_add = zeros(S,3);
    ...
    while s < S    
        ...
        %     end
        try
            results =  PCP_ar1_run_add(sdd, c, sigma1, sigma2, rho, p_bar1, p_bar, T, H, M, BurnIn, mu_init, df, cont, options, partition, II, GamMat);
