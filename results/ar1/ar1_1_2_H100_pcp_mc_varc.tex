...
%\multicolumn{12}{l}{\footnotesize{(P)CP var mf: Time Varying Censoring, ad mf method.}} \\ 
%\multicolumn{12}{l}{\footnotesize{(P)CP var mle: Time Varying Censoring, MLE based method.}}  \\ 
\end{tabular}
\caption{Asymmetric (misspecified) AR(1) zero mean split normal model with $\sigma_{1} = 1$ and $\sigma_{2} = 2$: simulation results  the regular posterior, censored posterior (CP) and partially censored posterior (PCP) with different thresholds, time-constant  at $0$ (CP0, PCP0) and at the 10\% data percentile (CP10\%, PCP 10\%), and time-varying based on the model-free method and the MLE-based method.} 
